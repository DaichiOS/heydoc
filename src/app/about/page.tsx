          ...
          <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-xl border border-white/30 space-y-8">
            ...
            <section>
              ...
              <p className="text-lg text-slate-700 leading-relaxed">
                Unlike generic telehealth platforms, HeyDoc is purpose-built for fertility and pre-conception care. We have one goal — supporting your fertility journey with expert medical guidance. <Link href="/" className="text-[#1C1B3A] hover:underline font-medium">See how it works</Link>.
              </p>
            </section>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-700">Our model supports fertility clinics and streamlines referrals. We enhance continuity of care, not disrupt it. Interested in joining our network? <Link href="/careers" className="text-[#1C1B3A] hover:underline font-medium">View careers</Link>.</p>
                  </div>
                </div>
              </div>
            </section>
