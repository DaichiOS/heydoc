	...
	return (
		<section className="pt-12 pb-10 bg-white relative overflow-hidden">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				{/* Phone Mockups Row - Hidden on mobile, visible on tablet+ */}
				<div className="hidden md:flex justify-center items-end gap-1 sm:gap-8 md:gap-12 lg:gap-16 mb-10 sm:mb-12 px-1 sm:px-12 overflow-visible">
